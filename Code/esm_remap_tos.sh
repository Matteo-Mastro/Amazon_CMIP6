...
scenario=(ssp585)
model=(MRI-ESM2-0 NorESM2-LM) # (ACCESS-ESM1-5 E3SM-1-1-ECA NorESM2-MM TaiESM1 BCC-CSM2-MR CanESM5 CMCC-ESM2 CNRM-ESM2-1 IPSL-CM6A-LR MIROC-ES2L UKESM1-0-LL MPI-ESM1-2-LR CESM2-WACCM) 
